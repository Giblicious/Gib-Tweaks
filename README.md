...
- Make the native status bar a direct, full-width footer at the bottom of the right sidebar, matching the left vault and settings footer height; main-workspace placement remains available as an option.
