...
- Embed the native status bar as a full-width footer inside the bottom-most right sidebar panel, matching the left vault and settings footer height; main-workspace placement remains available as an option.
